...
#gpu = run_command("sudo lshw -C display | grep prod | awk {'print $2, $3, $4, $5, $6, $7'}").strip("\n")
#audio = run_command("sudo lshw -C multimedia | grep prod | awk {'print $2, $3, $4, $5, $6, $7'}").strip("\n")
